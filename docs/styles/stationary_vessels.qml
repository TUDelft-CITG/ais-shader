...
<qgis layerType="Vector" styleCategories="Symbology|Temporal" version="4.2.1-Belém do Pará">
  ...
  <renderer-v2 attr="VesselGroup" enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Cargo" render="true" symbol="0" type="string" uuid="{e6fc1c38-ff1f-4d22-9924-fdabe5d28b91}" value="Cargo"/>
      <category label="Tanker" render="true" symbol="1" type="string" uuid="{e0ff3773-0520-42ad-8ff4-b8312a450a93}" value="Tanker"/>
      <category label="Tug" render="true" symbol="2" type="string" uuid="{cf809c9f-1388-4344-af0e-37997a8bb728}" value="Tug"/>
      <category label="Passenger" render="true" symbol="3" type="string" uuid="{9d85214c-8244-42ea-9495-9ac3a94f79c3}" value="Passenger"/>
      <category label="Pleasure Craft/Sailing" render="true" symbol="4" type="string" uuid="{7ba49296-ab88-427a-b61b-cf8dcf473bd3}" value="Pleasure Craft/Sailing"/>
      <category label="Fishing" render="true" symbol="5" type="string" uuid="{1683bbd2-f2ee-4135-be0a-5ea53b45387b}" value="Fishing"/>
      <category label="Military" render="true" symbol="6" type="string" uuid="{ac9ccafa-8504-4b36-96ce-5634d079fbd2}" value="Military"/>
      <category label="Other" render="true" symbol="7" type="string" uuid="{850251c4-bdc8-4895-957a-fa4ccd7ba262}" value="Other"/>
      <category label="" render="true" symbol="8" type="NULL" uuid="{af62e516-b96f-4b4c-a89f-a144bd9e632e}" value="NULL"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{5d87155a-a096-40b3-ae1b-16d54779d6a8}" locked="0" pass="0">
          <Option type="Map">
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="1" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{ded43a2f-2f76-4372-ab7a-c1bbce4975de}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="2" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{7944411d-6a17-4ce0-beaa-0646619daabb}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="3" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{0f18f9dd-102b-45d3-a8f6-6bd51ae20e69}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="4" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{a6d0b45c-6281-497c-91df-a1257a723ec9}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="5" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{9fee1265-fce9-4d36-95c6-a4f8143d470d}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="6" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{e968bea7-f303-405b-bf57-dd99968814d4}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="7" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{faab5076-8749-4a61-8af7-b0df82c59805}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="8" type="line">
        ...
        <!-- Single clean high saturation line -->
        <layer class="SimpleLine" enabled="1" id="{726f90e3-9370-4bf9-8339-fb5dffdb8e2b}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="round"/>
            <Option name="customdash" type="QString" value="5;2"/>
